...
- **Insights**: your performance metrics.

## What you can do

- See key metrics for your site and content.
- Understand what each metric means.
- Use the numbers to decide what to improve.

## Where to find it

Go to **Insights** in the admin to read your metrics.
